...
public class GoodsInfo {
    ...
    private int goodType;//商品栏目：1快捷栏，2计重栏
    ...
    public GoodsInfo(Long id, String goodName, double goodPrice,
            ...
            String goodPinyinCode, int goodType) {
        this.id = id;
    ...
    public GoodsType getGoodsType() {
        Long __key = this.id;
        if (goodsType__resolvedKey == null
                || !goodsType__resolvedKey.equals(__key)) {
